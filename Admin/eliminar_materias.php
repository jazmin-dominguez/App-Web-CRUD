<div class="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-md">
                    <form method="post" class="space-y-6">
                        <div>
                            <label for="idmodificar" class="block text-sm font-medium text-gray-700">
                                <i class="fa-solid fa-book-open-reader"></i> Select Subjects
                            </label>
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div>
                                <input type="submit" name="cargar" value="Delete Subject" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium px-4 py-2 bg-red-500 text-white font-bold rounded-md hover:bg-red-600">
                            </div>
                        </div>
                    </form>
                </div>
                ...
                if (isset($_POST['cargar'])) {
                    ...
                    $obj->eliminar_materia($id); // Asegúrate de tener esta función en tu clase Contacto
