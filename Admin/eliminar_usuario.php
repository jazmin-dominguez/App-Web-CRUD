<div class="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-md">
                    <form method="post" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div>
                                <input type="submit" name="cargar" value="Eliminar Usuario" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium px-4 py-2 bg-red-500 text-white font-bold rounded-md hover:bg-red-600">
                            </div>
                        </div>
                    </form>
                </div>
                ...
                if (isset($_POST['cargar'])) {
                    ...
                    echo "<p class='text-blue-600 mt-4'>Usuario eliminado con éxito</p>";
